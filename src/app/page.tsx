  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[var(--surface)] px-6 py-12">
      <section className="w-full max-w-3xl rounded-2xl border border-[var(--border)] bg-white p-8 shadow-sm sm:p-12">
        <p className="text-sm font-semibold text-[var(--secondary)]">EduSphere · Phase 1</p>
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-[var(--muted)]">
          The repository foundation is being established for the multi-school EduSphere platform.
          Business modules will be added only in their planned implementation phases.
        </p>
